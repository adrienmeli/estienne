...
`r ifpdf("", "[*(Download PDF)*](vocabulary.pdf)")`
...
```{r voctable, echo=FALSE, results='asis', message = FALSE, warning=FALSE }

df1 <- read_delim("vocabulary.csv", col_names=FALSE,delim=";",quoted_na=FALSE,na=character())
